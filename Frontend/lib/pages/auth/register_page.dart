...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _register(BuildContext context)async{
    if(nameController.text.isNotEmpty && emailController.text.isNotEmpty && passwordController.text.isNotEmpty){
      ...
      final response = await apiService.register(nameController.text, emailController.text, passwordController.text, bioController.text, profile);
      ...
      if(response['success'] == true){
        ...
        await key.setString("role", response['data']['role']);
        ...
        AwesomeDialog(
          ...
          title: "Sukses",
          desc: "${response['message']}, Selamat datang ${response['data']['name']} Anda berhasil register sebagai ${response['data']['role']}",
          btnOkOnPress: (){
            if(response['data']['role'] == 'artis'){
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ArtisFooterPage()));
            }else{
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => FooterPage()));
            }
          }
        ).show();
      }else{
                    ...
                    child: Stack(
                      ...
                      children: [
                        ClipRRect(
                          ...
                          : Image.file(File(profile!.path), width: 80, height: 80,),
                        ),
                        InkWell(
                          onTap: pilih,
                          child: CircleAvatar(
