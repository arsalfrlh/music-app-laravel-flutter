...
import 'package:music/pages/auth/register_page.dart';
    ...
    if(emailController.text.isNotEmpty && passwordController.text.isNotEmpty){
      ...
      if(response['success'] == true){
        ...
        AwesomeDialog(
          ...
          title: "Sukses",
          desc: "${response['message']}, Selamat datang ${response['data']['name']} Anda berhasil login sebagai ${response['data']['role']}",
          btnOkOnPress: (){
